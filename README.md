...
[![Unit Tests](https://github.com/logstash-plugins/logstash-input-http_poller/actions/workflows/unit-tests.yml/badge.svg?branch=main)](https://github.com/logstash-plugins/logstash-input-http_poller/actions/workflows/unit-tests.yml)
